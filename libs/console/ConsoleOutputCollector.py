...
def execute_app(app_full_path, param_list = [], cur_working_dir = None):
    ...
    if True:#try:
        ...
        p = subprocess.Popen(app_path_and_param_list, cwd = cur_working_dir, stdout = subprocess.PIPE, stderr = subprocess.PIPE, stdin = subprocess.PIPE, bufsize=0, creationflags = CREATE_NO_WINDOW)
        return p
...
class ConsoleOutputCollector:
    ...
    '''
    normal_priority_tasks = ["webserver-cgi", "startBeanstalkd.bat", "mongodb.bat", "cherrypyServerV4", "monitorServiceV2"]
