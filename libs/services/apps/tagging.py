import libsys
from libs.services.svc_base.service_base import Service
...
class TaggingService(Service):
    def __init__(self):
        ...
        self.gui_service.addItem({"command": "DropWnd", "target": self.get_input_msg_queue_name()})
    ...
    def process(self, msg):
        ...
        self.gui_service.addItem({"command": "Browser", "url": "http://127.0.0.1:" + str(
