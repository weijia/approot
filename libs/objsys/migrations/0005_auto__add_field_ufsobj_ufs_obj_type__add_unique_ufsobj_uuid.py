...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'UfsObj', fields ['uuid']
        db.create_unique('objsys_ufsobj', ['uuid'])


    def backwards(self, orm):
        # Removing unique constraint on 'UfsObj', fields ['uuid']
        db.delete_unique('objsys_ufsobj', ['uuid'])
    ...
    models = {
        ...
        'objsys.ufsobj': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5e740cc6-e100-460e-9eef-decae0c6297a'", 'unique': 'True', 'max_length': '60'}),
            'valid': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        }
    }
