...
class DecZipFileOn7Zip(object):
    ...
    def addfile(self, adding_file, arcname=None):
        ...
        if os.path.exists(self.file_path):
            ...
            original_size = 0
        cmd = (u'%s -p%s l "%s"' % (get_app_full_path_by_name("7z"), self.password, self.file_path, adding_file)).encode(gLocalEncode)
        print "command:", cmd
...
if __name__ == "__main__":
    d = DecZipFileOn7Zip("D:\\work\\mine\\codes\\ufs_django\\tasty_pie_encrypted"+
                     "\\Richard-PC\\2013\\10\\09\\1381330659.94.7z", password="")
    print d.list()