...
class Demo():
    _consumer_key = "xcJ22zDK7GEjwO5H"
    _consumer_secret = "MLjrPBC701Qyi3R2"
...
if __name__ == "__main__":
    ...
    demo.test_metadata()
    demo.test_shares()
    demo.test_create_folder()
    demo.test_delete()
    demo.test_move()
    demo.test_copy()
    demo.test_upload_file()
    demo.test_upload_file()

    demo.test_download_file()
    demo.test_thumbnail()
    demo.test_document_view()
